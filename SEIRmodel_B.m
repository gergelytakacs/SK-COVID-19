...
fitBegin=1;                              % Day to begin the fit
...
lambda_guess = [0.3,0.05];              % recovery rate
...
N = numel(time1);
t = [0:N-1].*dt;
[Ss,Es,Is,Qs,Rs,Ds,Ps] = SEIQRDP(alpha1,beta1,gamma1,delta1,Lambda1,Kappa1,Npop,1,1,1,0,0,t);
semilogy(time1,Qs,'r',time1,Rs,'b',time1,Ds,'k');
hold on
